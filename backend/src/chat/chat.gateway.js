...
var ChatGateway = /** @class */ (function (_super) {
    __extends(ChatGateway, _super);
    function ChatGateway(chatService, usersService, channelService) {
    ...
    ChatGateway.prototype.handleConnection = function (socket) {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    ChatGateway.prototype.handleDisconnect = function (client) { };
    ChatGateway.prototype.handleMessage = function (data, socket) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.chatService.saveMessage(data)];
                    case 1:
                        message = _a.sent();
