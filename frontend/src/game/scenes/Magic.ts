...
import { Spell } from "../sprites/spell";
...
export default class MagicScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.spell.setFrame(1);
    this.spell.setCollideWorldBounds(true);
    this.physics.add.collider(this.spell, this.paddle_left);
    this.physics.add.collider(this.spell, this.paddle_right);
